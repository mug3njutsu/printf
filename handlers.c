 ...
 * @flag: *p -> potential string of flags.
 ...
 * @modifier: *p -> potential length modifier.
 * @index: An index counter for the original format str.
 * Return: stuff
 */
 ...
 * @modifier: *p -> potential width modifier.
 * @index: an index counter for the original format str.
 * Return: stuff
 */
 ...
 * @args: a va_list of args.
 * @modifier: *p -> potential precision modifier.
 * @index: an index counter for the original format string.
 * Return: stuff
 */
 ...
 * @specifier: *p -> potential conversion specifier.
 * Return: stuff
 */
